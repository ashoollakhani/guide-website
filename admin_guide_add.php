...
if (!isset($_SESSION['admin_name'])) {
    header('Location: insert_admin_guide.php');
    ...
    if (!is_dir("images/guide_images/")) {
        ...
        if ($fsize >= 10000000) { // 10MB limit
            ...
            if ($result->num_rows > 0) {
                ...
                $stmt->bind_param("ssssiiiss", $_SESSION['admin_name'], $title, $details, $fnew, $status, $like_count, $dislike_count, $slug, $coordinates);
                ...
                if ($stmt->execute()) {
                    ...
                    <script type="text/javascript">
                        ...
                        window.location.href = "insert_admin_guide.php";
                    </script>
                    <?php
                    exit; // Add exit to stop executing further code
                } else {
